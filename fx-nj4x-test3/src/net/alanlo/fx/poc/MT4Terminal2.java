...
public class MT4Terminal2 extends Strategy {
	...
	public MT4Terminal2(String terminalServerIp, int terminalServerPort, String mt4Server, String mt4Login,
			String mt4Password) {
	...
	public void printtest() {
		...
		System.out.println(this.symbols.size());
...
//            iCustom(getSymbol(), Timeframe.PERIOD_H1, "ZigZag", 0, 0, 12, 5, 3);
	...
	public static void main(String[] args) {
		...
		MT4Terminal2 mt4 = new MT4Terminal2("127.0.0.1", 7788, "EmperorFinancial-Demo", "800035556", "5uqn894");
